...
public class MainActivity extends AppCompatActivity {
    ...
    public void onDrawGraph (View v){
        ...
        showErrors.setVisibility(View.INVISIBLE);//виключення видимості текстового поля
        graph.removeAllSeries();//Очищення поля графіку
        ...
        {
            showErrors.setVisibility(View.VISIBLE);//включення видмості тексотового поля
            String x1,x2,t;
